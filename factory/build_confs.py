...
confs_names = [
    'Shadowrocket_backcn',
    'Shadowrocket_backcn_ad'
]


def getRulesStringFromFile(path, kind, preprocess = True):
...
if __name__ == "__main__":
    ...
    values['StreamingCN'] = getRulesStringFromFile('resultant/StreamingCN.list', 'Proxy', False)
